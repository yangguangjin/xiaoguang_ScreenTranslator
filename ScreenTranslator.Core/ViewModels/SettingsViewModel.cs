...
public partial class SettingsViewModel : ObservableObject
{
    ...
    public SettingsViewModel(SettingsService settingsService, IMonitorService monitorService, int? currentMonitorIndex = null)
    {
    ...
    private void LoadMonitorList(IMonitorService monitorService)
    {

...
public class WindowsHotkeyService : IHotkeyService
{
    ...
    private EventMask _mouseModifiers;
    ...
    private void OnMouseSideButtonPressed(object? sender, int xButton)
    {
        ...
        // For mouse hotkeys, we fire directly (modifier check would need platform-specific code)
    ...
    private static bool TryParseMouseHotkey(string hotkeyString, out int mouseButton, out EventMask modifiers)
    {
        mouseButton = 0;
